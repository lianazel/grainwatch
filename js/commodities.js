...
const ALL_COMMODITIES = [
  ...
  { id: "sugar",       name: "Sucre",           nameEN: "Sugar",           code: "SUGAR",     icon: "🍬", unit: "¢/kg",     unitWB: "¢/kg",     basePrice: 19.80,  category: "softs" },
  { id: "coffee",      name: "Café",            nameEN: "Coffee",          code: "COFFEE",    icon: "☕", unit: "¢/kg",     unitWB: "¢/kg",     basePrice: 182.50, category: "softs" },
  ...
  { id: "cotton",      name: "Coton",           nameEN: "Cotton",          code: "COTTON",    icon: "☁️", unit: "¢/kg",     unitWB: "¢/kg",     basePrice: 72.30,  category: "fibers" },
  ...
  { id: "rubber",      name: "Caoutchouc",      nameEN: "Rubber",          code: "RUBBER",    icon: "🛞", unit: "¢/kg",     unitWB: "¢/kg",     basePrice: 155,    category: "industrials" },
  { id: "tea",         name: "Thé",             nameEN: "Tea",             code: "TEA",       icon: "🍵", unit: "¢/kg",     unitWB: "¢/kg",     basePrice: 265,    category: "softs" },
  { id: "orange",      name: "Jus d'orange",    nameEN: "Orange Juice",    code: "ORANGE",    icon: "🍊", unit: "¢/kg",     unitWB: "¢/kg",     basePrice: 320,    category: "softs" },
  ...
  { id: "wool",        name: "Laine",           nameEN: "Wool",            code: "WOOL",      icon: "🐑", unit: "¢/kg",     unitWB: "¢/kg",     basePrice: 980,    category: "fibers" },
